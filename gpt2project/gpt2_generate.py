...
from gpt2project.search_methods_gpt import AutoregressiveInferenceResults, GPT_search_method, topk_sampling_gpt
...
def generate_autoregressivly_gpt2_with_uq(
    ...
    for n in range(hyperparameters.uq.num_inferences):
        ...
        for b in range(batch_size):
            hypothesis[b].append(decode_token_list(output.token_ids[b].tolist(), tokenizer))
