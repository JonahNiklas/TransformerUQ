...
import tiktoken
from gpt2project.data_processing.abstract_evaluation_dataset import AbstractEvaluationDataset
...
def main() -> None:
    # ##### CONFIGURATIONS #####
    dataset: AbstractEvaluationDataset = CommonGenDataset() # or LambadaDataset() or TriviaQADataset() or SquadDataset()
